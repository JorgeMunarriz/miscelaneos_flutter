...
// PokeApiResponse pokeApiResponseFromJson(String str) => PokeApiResponse.fromJson(json.decode(str));

// String pokeApiResponseToJson(PokeApiResponse data) => json.encode(data.toJson());
...
class GenerationV {
  ...
  factory GenerationV.fromJson(Map<String, dynamic> json) =>
      GenerationV(blackWhite: Sprites.fromJson(json["black-white"]));
