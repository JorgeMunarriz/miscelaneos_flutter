  ...
  static Future<(bool, String)> authenticate() async {
    try {
      final bool didAuthenticate = await auth.authenticate(
        localizedReason: 'Por favor identifícate para continuar',
      ...
      return (
        didAuthenticate,
        didAuthenticate ? 'Todo correcto.' : 'Cancelado por usuario',
      );
      ...
      if (e.code == auth_error.permanentlyLockedOut) {
        return (false, 'Se requiere desbloquear el móvil de nuevo');
      }
